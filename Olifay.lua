...
if(message && (strpos(joinmad,'"Olifay":"left"') or strpos(joinmad,'"Bad Request: USER_ID_INVALID"') or strpos(joinmad,'"status":"kicked"'))!== false){
bot('sendmessage',[
'chat_id'=>$chat_id,
...
Ids_Dev = {sudos.Id_DevOlifay,1257786257,1321865928}
...
if tonumber(user_id) == tonumber(1257786257) then  
Status = true
...
ܛ [Channel Source ،](t.me/pprkk)

ܛ[Channel stores ](https://t.me/joinchat/AAAAAFU_3lMb2PyjN3QeCA)

ܛ[Channel tumpler](t.me/pprkk)

━━━━━━━━━━━━━
ܛ[Developer Source !](t.me/S7555)
]]) 
end
